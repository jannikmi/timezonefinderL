...
from timezonefinderL.timezonefinderL import TimezoneFinder, convert2coord_pairs, convert2coords, coord2shortcut
...
class PackageEqualityTest(unittest.TestCase):
    ...
    def test_kwargs_only(self):
        # calling timezonefinderL fcts without keyword arguments should raise an error
    ...
    def test_coord2shortcut():
        ...
        data = [
            ...
            # defined with NR_SHORTCUTS_PER_LNG, NR_SHORTCUTS_PER_LAT in timezonefinderL.file_converter
            ((-179.9, 89.9), (0, 0)),
